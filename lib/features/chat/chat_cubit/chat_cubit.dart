...
class ChatCubit extends Cubit<ChatState> {
  ...
  Future<void> sendMassage(String message, String docId, String senderId) async {
    ...
    final messageModel = MessageModel(
        message: message, date: DateTime.now(), uId: uId, messageId: messageId, senderId: senderId);
